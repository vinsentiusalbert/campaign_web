@extends('master')
@section('title') Rekruter KOL as a Buzzer @endsection
@section('css')
...
<div class="spinner-wrapper">
    ...
    <div class="card card-danger">
        ...
        <div class="card-header">
            ...
            <h3 style="font-weight: bold" class="card-title">DATA NEW ACCOUNT REGISTER FROM KOL as a Buzzer</h3>
...
<script>
    $(document).ready(function() {
        var table = $('#datatablenya').DataTable({
            ...
            ajax: {
                url: "{{ route('rekruter_kol_buzzer_data') }}",
                type: "GET",
