...
@section('title', 'Detail Campaign Orbit')
...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title font-weight-bold">Detail Campaign Orbit</h3>
    </div>
    ...
    <div class="card-body">
        ...
        <div class="form-group d-flex gap-2 mt-3">
            <a href="{{ route('campaign-orbit.index') }}" class="btn btn-secondary flex-grow-1 m-1">
                Kembali
            </a>
            <a href="{{ route('campaign-orbit.edit', $campaign->id) }}" class="btn btn-warning flex-grow-1 m-1">
                Edit
            </a>
        </div>
