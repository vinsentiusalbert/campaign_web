...
@section('title', 'Edit Campaign Soundbox')
...
<div class="card card-warning">
    <div class="card-header">
        <h3 class="card-title">Edit Campaign Soundbox</h3>
    </div>

    <form action="{{ route('campaign-soundbox.update', $campaign->id) }}"
          method="POST"
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <select name="campaign_usecase" class="form-control select2">
                    <option value="">-- Pilih --</option>
                    <option value="Rental"
                        {{ old('campaign_usecase', $campaign->campaign_usecase) == 'Rental' ? 'selected' : '' }}>
                        Rental
                    </option>
                    <option value="Beli Putus"
                        {{ old('campaign_usecase', $campaign->campaign_usecase) == 'Beli Putus' ? 'selected' : '' }}>
                        Beli Putus
                    </option>
                </select>
            </div>
        ...
        <div class="card-footer d-flex">
            <a href="{{ route('campaign-soundbox.index') }}" class="btn btn-secondary flex-grow-1 mr-2">
                Kembali
            </a>
