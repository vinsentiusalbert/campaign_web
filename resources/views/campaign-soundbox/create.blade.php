...
@section('title', 'Create Campaign Soundbox')
...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">Create Campaign Soundbox</h3>
    </div>

    <div class="card-body">
        <form action="{{ route('campaign-soundbox.store') }}" 
              method="POST" 
            ...
            <div class="form-group">
                ...
                <select name="campaign_usecase" class="form-control select2">
                    <option value="">-- Pilih --</option>
                    <option value="Rental" {{ old('campaign_usecase') == 'Rental' ? 'selected' : '' }}>Rental</option>
                    <option value="Beli Putus" {{ old('campaign_usecase') == 'Beli Putus' ? 'selected' : '' }}>Beli Putus</option>
                </select>
            </div>
