...
@section('title', 'Edit Campaign WABA Interaktif')
...
<div class="card card-warning">
    <div class="card-header">
        <h3 class="card-title">Edit Campaign WABA Interaktif</h3>
    </div>

    <form action="{{ route('campaign-waba-interaktif.update', $campaign->id) }}"
          method="POST"
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" id="template_name" name="template_name" class="form-control"
                       value="{{ old('template_name', $campaign->template_name) }}">
            ...
            <div class="form-group">
                ...
                <select name="campaign_usecase" class="form-control select2">
                    ...
                    <option value="Sales/Leads"
                        {{ old('campaign_usecase', $campaign->campaign_usecase) == 'Sales/Leads' ? 'selected' : '' }}>
                        Sales/Leads
                    </option>
                    <option value="Retention/Reminder"
                        {{ old('campaign_usecase', $campaign->campaign_usecase) == 'Retention/Reminder' ? 'selected' : '' }}>
                        Retention/Reminder
                    </option>
                </select>
            </div>
        ...
        <div class="card-footer d-flex">
            <a href="{{ route('campaign-waba-interaktif.index') }}" class="btn btn-secondary flex-grow-1 mr-2">
                Kembali
            </a>
