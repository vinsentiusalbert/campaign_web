        ...
        <form action="{{ route('campaign-kam.store') }}" 
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" id="text_button" name="text_button" class="form-control" value="{{ old('text_button') }}">
                    @error('text_button') <small class="text-danger">{{ $message }}</small> @enderror
                </div>
                <div class="form-group col-md-6">
                    <label for="link_button">Link Button</label>
                    <input type="text" id="link_button" name="link_button" class="form-control" value="{{ old('link_button') }}">
