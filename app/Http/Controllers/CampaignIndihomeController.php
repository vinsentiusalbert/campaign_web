...
class CampaignIndihomeController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'campaign_usecase' => 'nullable|string',
            'message_body' => 'nullable',
            'kv_message_link' => 'nullable|string',
            'campaign_type' => 'nullable|string',
            'nama_file_whitelist' => 'nullable|string',
            'longitude_latitude' => 'nullable|string',
            'radius' => 'nullable|string',
            'periode_campaign_start' => 'nullable|date',
            'periode_campaign_end' => 'nullable|date',
            'jumlah_blast' => 'nullable|integer',
        ]);
        // dd($request->all());    
